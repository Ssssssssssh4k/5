...
def robots_function(input_filename, output_filename):
...
# Чтобы протестировать работу введите в браузере
# http://localhost:5000/start

if __name__ == '__main__':

    file_name = 'C:\\Users\\De Neas\\Desktop\\Labs\\Lab3\\images\\icecream.pnm'
    result_file_name = 'C:\\Users\\De Neas\\Desktop\\Labs\\Lab3\\result\\icecream.pnm'

    app = Flask(__name__)

    @app.route('/start')
    def start_robot():
        robots_function(file_name, result_file_name)
